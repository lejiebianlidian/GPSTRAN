...
namespace NeiMeng_UDP_2
{
    ...
    public class Plugin : Protocol,IPlugin
    {
        ...
        private void Run()
        {
            ...
            var neimeng = new Neimeng();
            neimeng.head.SetValue();
            byte[] data;
            while (true)
            {
                while (dataQueue.Count > 0)
                {
                    ...
                    neimeng.body.SetValue(gps.TBody);
                    
                    data = GetByte(neimeng);
                    ...
                    //else
                    //{
                    //    //todo:TCP send GPSData
                    //    //tcpClient.Connect(Resource.IPInstanceList[s].EndPoint);
