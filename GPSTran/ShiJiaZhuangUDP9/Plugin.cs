   ...
   public class Plugin : IPlugin
    {
        ...
        private ShiJiaZhuangProtocol ShiJiaZhuangpro;
        ...
        private bool isStop;
        private ShiJiaZhuangGps ShiJiaZhuangGPS;
        private ShiJiaZhuangTBody ShiJiaZhuangTBody;
        private ShiJiaZhuangTHead ShiJiaZhuangTHead;
        ...
        public Plugin(PluginModel pModel, bool threadStart)
        {
            ...
            boteHead[0] = 0x22;
            boteHead[1] = 0x00;
            ShiJiaZhuangPro = new ShiJiaZhuangProtocol();
            ShiJiaZhuangGPS = new ShiJiaZhuangGps();
            ShiJiaZhuangTHead = new ShiJiaZhuangTHead();

            ShiJiaZhuangTHead.wHeader = 0xAAAA;
            ShiJiaZhuangTHead.cmdFlag = 0xCCCC;
            ShiJiaZhuangTHead.versionFlag = 0x0022;
            ShiJiaZhuangTHead.bodyLength = System.Net.IPAddress.HostToNetworkOrder(51);

            ShiJiaZhuangTBody = new ShiJiaZhuangTBody();
                ...
                while (dataQueue.Count > 0)
                {
                    ...
                    foreach (int i in pModel.EntityID)
                    {
                        lock (Resource.lckISSIOfEntity)
                        {
                            ...
                            {
                                if (Resource.ISSIOfEntity[i.ToString()].ContainsKey(ShiJiaZhuangpro.GetIssi(data)))
                                {
                                    valid = 1;
                                    break;
                                }
                    ...
                    temp = ShiJiaZhuangpro.ByteClone(data);
                    ...
                    temp = ShiJiaZhuangpro.ModifyLaLon(temp, pModel.LonOffset, pModel.LatOffset);

                    //}
                    //解包temp 修改ISSI号，修改包文件头，重新封包
                    tempData = ShiJiaZhuangPro.ToGPSData(temp);
