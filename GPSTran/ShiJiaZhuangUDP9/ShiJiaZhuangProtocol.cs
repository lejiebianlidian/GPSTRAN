...
{
   public class ShiJiaZhuangProtocol
    {
        ...
        public byte[] GetByte(ShiJiaZhuangGps body)
        {
            //得到结构体的大小
            int size = Marshal.SizeOf(body);
            //创建byte数组
    ...
    public struct ShiJiaZhuangGps
    {
        public ShiJiaZhuangTHead neimengTHead;
        public ShiJiaZhuangTBody neimengTBody;
    }
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct ShiJiaZhuangTHead
    {
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct ShiJiaZhuangTBody
    {
    ...
    public struct ShiJiaZhuangTime
    {
        public ushort year;
        public byte month;
        public byte day;
