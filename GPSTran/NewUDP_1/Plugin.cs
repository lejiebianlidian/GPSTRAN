...
namespace NewUDP_1
{
    public class Plugin:IPlugin
    {
        ...
        private NewUdpProtocol neimengpro;
        ...
        private void Run()
        {
            ...
            while (true)
            {
                while (dataQueue.Count > 0)
                {
                    ...
                    tempHead = neimengPro.ToGPSHead(temp);
                    //if (tempHead.cmdFlag != 221)//如果不是22长度直接终止线程
                    //{
                    //    dealDataThread.Abort();
                    //}

                    temp = PacketForNeiMeng(tempData,tempHead);
